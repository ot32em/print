...
constexpr seq_t 
arg_seq(cstr str, char arg_c = '*', char esc_c = '%', unsigned int found_args = 0, unsigned int i = 0)
{
    return
...
constexpr std::size_t pos_of_nth_arg(cstr msg, unsigned nth_arg, char esc_c = '%', unsigned i = 0)
{
    return
