...
//                  byte 8     byte 7     byte 6     byte 5     byte 4     byte 3     byte 2     byte 1
    describe("bits_from_str", [&]() {
        it("checks byte1", []() {
            static_assert(bits_from_str(cstr(BITSTR_64W)) & bit_at(0,1,4,5), "byte 1");
        });
        it("checks byte2", []() {
            static_assert(bits_from_str(cstr(BITSTR_64W)) & bit_at(9), "byte 2");
        });
        it("checks byte4", []() {
            static_assert(bits_from_str(cstr(BITSTR_64W)) & bit_at(24, 29, 30, 31), "byte 4");
        });
        it("checks byte5", []() {
            static_assert(bits_from_str(cstr(BITSTR_64W)) & bit_at(32, 33, 34,35,36,37,38,39), "byte 5");
        });
        it("checks byte6", []() {
            static_assert(bits_from_str(cstr(BITSTR_64W)) & bit_at(40, 41,42,46), "byte 6");
        });
        it("checks byte7", []() {
            static_assert(bits_from_str(cstr(BITSTR_64W)) & bit_at(48,52), "byte 7");
        });
        it("checks byte8", []() {
